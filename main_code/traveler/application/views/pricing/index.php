...
<html>
			...
			<div class="row">
				...
				<div class="col-xs-8 text-right menu-1">
					<ul>
						...
						<li class="active"><a href="<?php echo base_url('pricing','http://')?>">Pricing</a></li>
	...
	<header id="gtco-header" class="gtco-cover gtco-cover-sm" role="banner" style="background-image: url(/style/images/img_2.jpg)">
